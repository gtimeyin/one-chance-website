  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex items-center gap-4">
        <Link
          href="/account/orders"
          className="font-['Barlow_Condensed'] text-[14px] text-neutral-400 hover:text-neutral-600 no-underline"
      ...
      <div className="flex flex-col items-end gap-2">
        <div className="flex items-center gap-8">
          <span className="font-['Barlow_Condensed'] text-[14px] text-neutral-500">Shipping</span>
          <span className="font-['Barlow_Condensed'] text-[14px] font-[600] text-neutral-800">
            {order.currency} {order.shipping_total}
          </span>
        </div>
        <div className="flex items-center gap-8">
          <span className="font-['Barlow_Condensed'] text-[16px] font-[700] text-neutral-800">Total</span>
          <span className="font-['Barlow_Condensed'] text-[20px] font-[700] text-neutral-800">
