    ...
    <div className="flex flex-col gap-3 p-6 border border-neutral-200">
      ...
      <div className="flex flex-col">
        ...
        {nodes.map((node) => (
          ...
          >
            <span className="flex-1 font-['Barlow_Condensed'] text-[14px] font-[500] text-neutral-800">
              {node.referee_name}
            </span>
            <span className="w-28 font-['Barlow_Condensed'] text-[13px] text-neutral-500">
            ...
            <span className="w-20 text-center font-['Barlow_Condensed'] text-[14px] font-[600] text-neutral-700">
              {node.orders_count}
            </span>
            <span className="w-28 text-right font-['Barlow_Condensed'] text-[14px] font-[600] text-green-600">
